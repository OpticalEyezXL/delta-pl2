...
| File | Description |
|---|---|
| `vol2_verification.py` / `vol2_verification_en.py` | Verifies the main calculations from the paper's appendices (Appendix A–Y) using sympy/numpy: the four limits, the rank-2 tidal tensor, agreement with Schwarzschild, the Kerr ring singularity, SU(3) closure, the SU(2) double cover, and more. |
